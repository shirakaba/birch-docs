...
This article gives some quick notes on some good tools for collecting build profiles to help speed up your builds.
...
![Xcode linear profile](./build-profiling-img/xcode-built-in.jpg)
...
![Xcode cascade profile](./build-profiling-img/xcode-cascade.jpg)
...
![Gradle Build Analyzer](./build-profiling-img/gradle-build-analyzer.png)
...
![Gradle dependency graph](./build-profiling-img/gradle-module-graph.png)
...
![Gradle Build Scan](./build-profiling-img/gradle-build-scan.png)
