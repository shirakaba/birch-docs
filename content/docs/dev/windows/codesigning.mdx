...
Using Visual Studio, right-click your project＊ and create an App Package using the [packaging wizard](https://learn.microsoft.com/en-us/windows/msix/package/packaging-uwp-apps#create-an-app-package-using-the-packaging-wizard) (i.e. `Publish > Create App Packages...`).
