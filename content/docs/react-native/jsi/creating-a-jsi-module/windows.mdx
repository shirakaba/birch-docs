...
This boilerplate will carry on from that step. By the end, we'll have a native module that installs a JSI `HostObject` onto the global object upon initialisation.
